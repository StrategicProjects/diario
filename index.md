...
which sets up and executes an authenticated request to the Diario API
endpoints.
...
This package is provided under the [MIT
License](https://strategicprojects.github.io/diario/LICENSE). See
LICENSE for details.
